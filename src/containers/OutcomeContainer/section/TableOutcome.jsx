...
const TableOutcome = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ value }) => (
        <a
          ...
          className="flex justify-center"
        >
          <IoReceipt className="size-[20px] text-primary-green-100" />
        </a>
      ),
      thClassName: "!w-[8%] !text-center",
    },
    ...
    },
    {
      ...
      accessor: "id",
      cell: ({ value, row }) => {
        const userOutcome = row?.createdBy?._id === userMe?._id;
  ...
  return (
    <div className="size-full flex flex-col bg-white rounded-md p-2">
      <div className="w-full p-3 flex justify-between items-center border-b">
        <div className="size-fit font-medium text-[21px]">History Outcome</div>
